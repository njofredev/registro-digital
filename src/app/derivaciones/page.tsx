...
import DerivacionesDashboardClient from './dashboard/DerivacionesDashboardClient';
...
export const metadata = {
  ...
  description: "Indicadores de rendimiento de derivaciones del Policlínico Tabancura",
};
