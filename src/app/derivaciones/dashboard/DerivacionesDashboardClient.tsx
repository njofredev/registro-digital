...
export default function DerivacionesDashboardClient({ data }: { data: any[] }) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card className="border-border/50 bg-card/40 backdrop-blur-xl shadow-lg hover:shadow-primary/5 transition-all duration-300">
          <CardHeader className="pb-2 flex flex-row items-center justify-between space-y-0">
            <CardTitle className="text-sm font-semibold text-muted-foreground">Volumen Derivaciones</CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Casos de derivación registrados</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-border/50 bg-card/40 backdrop-blur-xl shadow-lg hover:shadow-primary/5 transition-all duration-300">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Tons con más derivaciones</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-border/50 bg-card/40 backdrop-blur-xl shadow-lg hover:shadow-primary/5 transition-all duration-300">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Más utilizado en derivaciones</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-border/50 bg-card/40 backdrop-blur-xl shadow-lg hover:shadow-primary/5 transition-all duration-300">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Fecha con más derivaciones</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <Card className="p-6 border-border/50 bg-card/40 backdrop-blur-xl shadow-lg md:col-span-2 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <h3 className="font-bold text-lg tracking-tight flex items-center gap-2">
              ...
              Tendencia Temporal de Derivaciones
            </h3>
          ...
          <div className="h-[320px] w-full">
            {filteredTrendData.length === 0 ? (
              <div className="h-full flex items-center justify-center text-sm text-muted-foreground">
                No hay datos históricos de derivaciones para graficar aún.
              </div>
            ) : (
        ...
        <Card className="p-6 border-border/50 bg-card/40 backdrop-blur-xl shadow-lg md:col-span-2">
          ...
          <div className="h-[320px] w-full">
            {tonsData.length === 0 ? (
              <div className="h-full flex items-center justify-center text-sm text-muted-foreground">
                Sin registros de técnicos asignados.
              </div>
            ) : (
              <ResponsiveContainer width="100%" height="100%">
