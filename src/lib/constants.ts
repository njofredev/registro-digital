...
export const OPCIONES_BLOQUES = ["1 bloque", "2 bloques", "3 bloques", "4 bloques", "5 o más bloques"];

export const ESTADO_COLORS: Record<string, string> = {
  'Solicitado': 'bg-red-500/20 text-red-500',
  'En progreso': 'bg-orange-500/20 text-orange-500',
  'Aceptado': 'bg-green-500/20 text-green-500',
  'Entregado': 'bg-blue-500/20 text-blue-500',
  'Fresado': 'bg-purple-500/20 text-purple-500',
  'Diseñado': 'bg-cyan-500/20 text-cyan-500',
  'Listo': 'bg-emerald-500/20 text-emerald-500'
};
